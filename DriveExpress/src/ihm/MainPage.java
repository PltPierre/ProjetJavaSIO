...
public class MainPage extends JFrame implements MouseListener, MouseMotionListener, KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		//Même code que le clique sur le bouton valider avec entrée dans le change du mdp
